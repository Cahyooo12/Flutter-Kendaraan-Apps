...
// ─────────────────────────────────────────────────────────────
function AndroidStatusBar({ dark = false, bg }) {
...
function AndroidDevice({
  ...
  bg, statusBarBg, statusBarDark, gestureNavBg, gestureNavDark,
}) {
  return (
    <div style={{
      ...
      <AndroidStatusBar dark={statusBarDark ?? dark} bg={statusBarBg} />
      {title !== undefined && <AndroidAppBar title={title} large={large} />}
      <div style={{ flex: 1, overflow: 'auto' }}>
        {children}
      </div>
      {keyboard && <AndroidKeyboard />}
      <AndroidNavBar dark={gestureNavDark ?? dark} bg={gestureNavBg} />
    </div>
  );
}
